...
const ResultDetail = () => {
  ...
  return (
    <div>
      ...
      <p id="resultdetailnickname">{nickname}(님)에게 가장 적합한 취미는 &nbsp;
        <span className='priorityinterest'>
